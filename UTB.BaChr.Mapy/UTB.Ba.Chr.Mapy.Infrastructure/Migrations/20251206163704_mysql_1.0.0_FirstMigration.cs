...
{
    /// <inheritdoc />
    public partial class mysql_100_FirstMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Henryho věž. Hlavní stanoviště s výhledem na Shoshone National Forest.", 44.427999999999997, -110.5885, "Two Forks Lookout" },
                    { 2, "Oplocená biologická výzkumná stanice. Vstup přísně zakázán.", 44.43, -110.59, "Wapiti Station" },
                    { 3, "Klidné jezero na úpatí hor. Ideální místo pro odpočinek.", 44.424999999999997, -110.58, "Jonesy Lake" },
                    { 4, "Věž, kde sídlí Delilah. Viditelná pouze dalekohledem.", 44.435000000000002, -110.575, "Thorofare Lookout" }
                });
